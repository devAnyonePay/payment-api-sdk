        ...
        <v-app>
            <v-main>
                <v-container>
                    ...
                    <h3>Test making new payment request</h3>
                    <h4>2020.12.09 updated</h4>
                    <br/>
                    <v-row>
...
<script>
    ...
    var app = new Vue({
        ...
        data: {
            ...
            pgChannels : [
              { channel: 'None', value: '' },
              { channel: 'Globe Load', value: 'PGC01' },
              { channel: 'Gcash', value: 'PGC02' },
              { channel: 'Smart/Sun Load', value: 'PGC03' },
              { channel: 'Paymaya', value: 'PGC04' },
              { channel: 'Credit(Visa/Master/JCB)', value: 'PGC05' },
              { channel: 'Grabpay', value: 'PGC06' },
              { channel: 'BPI Bank', value: 'PGC08' },
            ],
            pgChannel : '',
        ...
        methods: {
            ...
            startpay: function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "/test/oneTime/registerPayment.php",
